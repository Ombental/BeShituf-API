"""
Django settings for BeShituf project.
...
class Base(Configuration):
    ...
    SECRET_KEY = values.Value('tahddoSmgmSvFHQZErtksxuvabBBiZYDPFBoOKOEnepNtFFdnz')
    ...
    BESHITUF_APPS = []
    INSTALLED_APPS = DJANGO_APPS + THIRD_PARTY_APPS + BESHITUF_APPS
    ...
    MIDDLEWARE = [
        ...
        'BeShituf.middleware.TimezoneMiddleware',
    ...
    WSGI_APPLICATION = 'BeShituf.wsgi.application'

    # Database
    # https://docs.djangoproject.com/en/3.1/ref/settings/#databases

    DATABASES = values.DatabaseURLValue('postgresql://BeShituf_user:BeShituf_pass@127.0.0.1:5432/BeShituf_db')
